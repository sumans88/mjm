...
class Template_tipe_input_form_register_model extends  CI_Model{
	
	var $table 		= 'template_tipe_input_form_register';
	var $tableAs 	= 'template_tipe_input_form_register a';
	...
	function deleteByIdTemplate($data,$id){
...
/* End of file template_tipe_input_form_register_model.php */
/* Location: ./application/model/template_tipe_input_form_register_model.php */