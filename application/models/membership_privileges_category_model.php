<?php
class membership_privileges_category_model extends  CI_Model{
	var $table            = 'ref_privileges_category';
	var $tableAs          = 'ref_privileges_category a';
	...
	function records($where=array(),$isTotal=0){
		...
		$this->db->select('a.*, b.name as status');
